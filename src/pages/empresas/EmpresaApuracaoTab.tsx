...
export function EmpresaApuracaoTab({ empresa }: EmpresaApuracaoTabProps) {
  ...
  // Modal Lançamento de Faturamento
  ...
  const handleSaveFaturamento = async (e: React.FormEvent) => {
    ...
    setSavingFat(true)
    try {
      await upsertFaturamentoMes(empresa.id, ano, fatMes, recNum, folhaNum)
      toast({ title: `Faturamento de ${MESES_NOMES[fatMes - 1]}/${ano} atualizado!` })
          ...
          <form onSubmit={handleSaveFaturamento}>
            <DialogHeader>
              <DialogTitle className="flex items-center gap-2 text-base font-bold text-slate-900">
                ...
                Lançar Faturamento — {MESES_NOMES[fatMes - 1]}/{ano}
              </DialogTitle>
              <DialogDescription className="text-xs text-slate-500">
                Informe a receita bruta mensal e os encargos de folha salarial da empresa.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-3">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[10px] text-slate-400">
                  Utilizado para o cálculo do Fator R no Simples Nacional e deduções contábeis.
                </p>
              </div>
            </div>
